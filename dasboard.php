        ...
        <div class="controls">
            ...
            <script>
                ...
                input.addEventListener("input", function() {
                    ...
                    var today = new Date();
                    var workStartTime = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 10, 0, 0); // 
                    var workEndTime = new Date(today.getFullYear(), today.getMonth(), today.getDate(), 19, 0, 0); // 
                    ...
                    if (selectedDate < today) {
                        ...
                        input.setCustomValidity("Appointments are only available between 10:00 AM and 07:00 PM.");
                    } else {
