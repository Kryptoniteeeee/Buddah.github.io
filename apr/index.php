...
◾ Torsion Controller</p>
						...
						<ul class="actions">
							<li><a href="#three" class="button">Schedule Now</a></li>
						</ul>
					</div>
			...
			<!-- Three -->
				<section id="three" class="spotlight style3 left">
					...
					<div class="content">
						...
						<p> <br>Proceed Login to Make a Reservartion Now </p>

<p><a href="login.php" class="button primary" title="Click Here to Login" id="login">Login</a></p>
							<p><a rel="tooltip"  data-placement="bottom" title="Click Here to Sign UP" id="signup" href="signup.php">Not a Member? Sign Up Now</a></p>
